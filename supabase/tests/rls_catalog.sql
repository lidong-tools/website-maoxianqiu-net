...
values
  ...
  ('aaaaaaaa-0000-0000-0000-000000000001', (select id from public.employees where employee_no = 'EMP-ADMIN-C'), (select id from public.roles where code = 'system_admin'), null)
on conflict do nothing;
